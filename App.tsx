      ...
      cardStyle: { backgroundColor: '#afc7d8' }
        ...
        <Stack.Screen name="EditProfile" component={EditProfilePage} options={{ title: '' ,
          headerStyle: {
           ...
           <Stack.Screen name="ProfileUpdatePassword" component={ProfileUpdatePasswordPage} options={{ title: '' ,
          headerStyle: {
            backgroundColor: '#afc7d8',
          }}}/>
          <Stack.Screen name="ProfileUpdateNamelast" component={ProfileUpdateNamelastPage} options={{ title: '' ,
          headerStyle: {
            backgroundColor: '#afc7d8',
          }}}/><Stack.Screen name="ProfileUpdateBio" component={ProfileUpdateBio} options={{ title: '' ,
          headerStyle: {
            backgroundColor: '#afc7d8',
          }}}/>
